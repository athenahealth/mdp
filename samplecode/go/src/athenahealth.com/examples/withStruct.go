...
func main() {
	...
	////////////////////////////////////////////////////////////////////////////////////////////////
	customfields, err := api.GETs(athenahealthapi.Req{
		Path: "/customfields",
	})
	if err != nil {
		panic(err)
	...
	openAppts, err := api.GETs(athenahealthapi.Req{
	...
	newPatient, err := api.POSTs(athenahealthapi.Req{
		Path:   "/patients",
		Params: patientInfo,
	})
	if err != nil {
	...
	_ = appointmentInfo
	booked, err := api.PUTs(athenahealthapi.Req{
		Path:   pathJoin("/appointments", appt["appointmentid"].(string)),
	...
	////////////////////////////////////////////////////////////////////////////////////////////////
	checkedIn, err := api.POSTs(athenahealthapi.Req{
		Path: pathJoin("/appointments", appt["appointmentid"].(string), "/checkin"),
	})
	if err != nil {
		panic(err)
	}
	...
	////////////////////////////////////////////////////////////////////////////////////////////////
	removedChartAlert, err := api.DELETEs(athenahealthapi.Req{
		Path:   pathJoin("/patients", newPatientID.(string), "chartalert"),
		Params: map[string]string{"departmentid": "1"},
	})
	if err != nil {
		panic(err)
	}
	...
	////////////////////////////////////////////////////////////////////////////////////////////////
	removedAppointment, err := api.DELETEs(athenahealthapi.Req{
		Path: pathJoin("/appointments", appt["appointmentid"].(string)),
	})
	if err != nil {
		panic(err)
	...
	// Error conditions
	////////////////////////////////////////////////////////////////////////////////////////////////
	badPath, err := api.GETs(athenahealthapi.Req{
		Path: "/nothing/at/this/path",
	})
	if err != nil {
		panic(err)
	}
	...
	fmt.Println(badPath)
	missingParameters, err := api.GETs(athenahealthapi.Req{
		Path: "/appointments/open",
	})
	if err != nil {
		panic(err)
	...
	if false {
		...
		_, err := api.GETs(athenahealthapi.Req{
			Path: "/departments",
		})
		if err != nil {
			panic(err)
